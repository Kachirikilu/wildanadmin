...
function Menu() {
    ...
    let chatButton = document.getElementById("NavCenterXChat");
    ...
    if (user.style.display == "inline") {
        ...
        chatButton.style.animation = "homeback 340ms ease forwards"
...
function DataUser() {
    ...
    if (wallpaper.style.display == "none") {
        ...
        if (profil.style.display == "none") {
            if (chatButton.style.display == "inline") {
                chatButton.style.animation = "homebackR 340ms ease forwards"
                setTimeout(out, 340);
                function out() {

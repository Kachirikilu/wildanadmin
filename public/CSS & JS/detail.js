...
document.getElementById("buttonNavChatM").onmouseover = function() {menuMouseOverChatM()};
document.getElementById("buttonNavChatM").onmouseout = function() {menuMouseOutChatM()};
...
function menuMouseOverChatM() {
    let icon = document.getElementById("iconCM");
        if (icon.style.animation == "iconAni 400ms ease forwards") {
            }
        else {
            icon.style.animation = "iconAni 400ms ease forwards";
        }
    let text = document.getElementById("textCM");
        if (text.style.animation == "textAni 400ms ease forwards") {
            }
        else {
            text.style.animation = "textAni 400ms ease forwards";
...
document.getElementById("buttonNavProfilM").onmouseover = function() {menuMouseOverProfilM()};
document.getElementById("buttonNavProfilM").onmouseout = function() {menuMouseOutProfilM()};
...
function menuMouseOverProfilM() {
    let icon = document.getElementById("iconPM");
        if (icon.style.animation == "iconAni2 400ms ease forwards") {
            }
        else {
            icon.style.animation = "iconAni2 400ms ease forwards";
        }
    let text = document.getElementById("textPM");
        if (text.style.animation == "textAni 400ms ease forwards") {
            }
        else {
            text.style.animation = "textAni 400ms ease forwards";
...
//     let homeButton = document.getElementById("NavCenterXHome");
//     let backButton = document.getElementById("NavCenterXBack");
//     let chatButton2 = document.getElementById("NavCenterXChat2");
//     let backButton2 = document.getElementById("NavCenterXBack2");

//     let user = document.getElementById("ul-top3DU")
//     let profil = document.getElementById("ul-top3DP")

//     if (user.style.display == "inline") {

//         homeButton.style.animation = "homeback 340ms ease forwards"
//         backButton.style.animation = "homebackR 340ms ease forwards"
//         chatButton2.style.animation = "homeback 340ms ease forwards"
//         backButton2.style.animation = "homebackR 340ms ease forwards"
//         setTimeout(out, 340);
//         function out() {
//             homeButton.style.display = "inline"
//             backButton.style.display = "none"
//             chatButton2.style.display = "inline"
//             backButton2.style.display = "none"
//         }
//     }

//     if (profil.style.display == "inline") {
...
//     if (backButton.style.display == "inline") {
//         homeButton.style.display = "none";
//     } else {
//         homeButton.style.display = "inline";
//     }

//     if (backButton2.style.display == "inline") {
...
//             if (homeButton.style.display == "inline") {
//                 homeButton.style.animation = "homebackR 340ms ease forwards"
//                 setTimeout(out, 340);
//                 function out() {
//                     backButton.style.animation = "homeback 340ms ease forwards"
//                     homeButton.style.display = "none"
...
//                 }
//             }
//             if (chatButton2.style.display == "inline") {
//                 chatButton2.style.animation = "homebackR 340ms ease forwards"
//                 setTimeout(out, 340);
//                 function out() {
//                     backButton2.style.animation = "homeback 340ms ease forwards"
//                     chatButton2.style.display = "none"
...
//     if (profilClose.style.display == "inline") {
//         setTimeout(out, 500);
//         profilClose.style.animation = "ul-top3WR 500ms ease forwards"
//         function out() {
//             profilClose.style.display = "none"
//         }
//         if (user.style.display == "none") {
...
//     if (userClose.style.display == "inline") {
//         setTimeout(out, 500);
//         userClose.style.animation = "ul-top3WR 500ms ease forwards"
//         function out() {
//             userClose.style.display = "none"
//         }
//         if (profil.style.display == "none") {
...
// document.getElementById("buttonNavHomeX2").onmouseover = function() {menuMouseOverHomeX2()};
// document.getElementById("buttonNavHomeX2").onmouseout = function() {menuMouseOutHomeX2()};
...
//         }
// }
// function menuMouseOverHomeX2() {
//     let icon = document.getElementById("iconHX2");
//         if (icon.style.animation == "iconAni 400ms ease forwards") {
//             }
//         else {
//             icon.style.animation = "iconAni 400ms ease forwards";
//         }
//     let text = document.getElementById("textHX2");
//         if (text.style.animation == "textAni 400ms ease forwards") {
//             }
//         else {
//             text.style.animation = "textAni 400ms ease forwards";

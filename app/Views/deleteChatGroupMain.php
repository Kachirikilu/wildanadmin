...
<body id="background" onload="startTime()">
    ...
    <?php $userX = $user->where('ID', $chatGroup['IDUserName'])->first() ?>

    <?php if ($userX !== null) { ?>

        <?php if (session()->get('Pangkat') == "CEO") { ?>
            <title>Delete <?= $userX['Name'] ?> Chat Group | Owner</title>
        <?php } else if (session()->get('Pangkat') == "Admin") { ?>
            <title>Delete <?= $userX['Name'] ?> Chat Group | Admin</title>
        <?php } else if (session()->get('Pangkat') == "User") { ?>
            <title>Delete <?= $userX['Name'] ?> Chat Group | User</title>
        <?php } else if (session()->get('Pangkat') == null) { ?>
            <title>Delete <?= $userX['Name'] ?> Chat Group | Visitor</title>
        <?php } ?>

    <?php } else { ?>

        <?php if (session()->get('Pangkat') == "CEO") { ?>
            <title>Delete Unknown Chat Group | Owner</title>
        <?php } else if (session()->get('Pangkat') == "Admin") { ?>
            <title>Delete Unknown Chat Group | Admin</title>
        <?php } else if (session()->get('Pangkat') == "User") { ?>
            <title>Delete Unknown Chat Group | User</title>
        <?php } else if (session()->get('Pangkat') == null) { ?>
            <title>Delete Unknown Chat Group | Visitor</title>
        <?php } ?>
                        ...
                        <center>
                            <div class="WadahDelete">
                                ...
                                <div class="WadahEditKomenIsiforDelete">
                                    <form action="/delete_chat_group_main/<?= $chatGroup['ID']; ?>" id="deleteForm" method="post">
                                        <?= csrf_field(); ?>

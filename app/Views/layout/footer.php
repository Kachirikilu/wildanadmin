       ...
       <div id="footer">
           <div id="WadahKaki">
               <div id="WadahKakiText1">
                   ...
                   <div id="DIVaFooter"><a href="/beta" id="aFooter">V4.32.804 Stable</a></div>
               ...
               <div id="WadahKakiText2">
                   <?php if (session()->get('Pangkat') !== null) { ?>
                       ...
                       <div id="DIVaFooter"><a href="/calculator" id="aFooter">Calculator</a></div>
   ...
   <script src="/CSS & JS/admin.js?v=<?php echo time(); ?>" defer></script>

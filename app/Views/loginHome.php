    ...
    <div id="diviPhone" style="display: flex;" class="diviPhone">
        ...
        <main class="WadahKalkulatorHP">
            <div class="layerKalkulatorOnHPMobile" id="layarHP" style="display: inline;">
                ...
                <div id="poni">
                    <div id="poniX"><a href="/registrasi" style="text-decoration: none; color: white;">Go to registration</a></div>
                </div>
                    ...
                    <div class="iFrameDivX">
                        <div class="iFrameLoginMobile" id="iFrame">
                            ...
                            <div class="loginDiv">
                                ...
                                <form action="/registrasicontroller/login" id="login" method="post" enctype="multipart/form-data">
                                    <center>
                                ...
                                <center>
                                    <a href="/registrasi" class="NewAccount">New account</a>
...
<head>
    ...
    <?php if (session()->get('Pangkat') == "CEO") { ?>
        <title>Edit <?= session()->get('Name') ?> Chat | Owner</title>
    <?php } else if (session()->get('Pangkat') == "Admin") { ?>
        <title>Edit <?= session()->get('Name') ?> Chat | Admin</title>
    <?php } else if (session()->get('Pangkat') == "User") { ?>
        <title>Edit <?= session()->get('Name') ?> Chat | User</title>
    <?php } else if (session()->get('Pangkat') == null) { ?>
        <title>Edit <?= session()->get('Name') ?> Chat | Visitor</title>
    <?php } ?>
...
<body id="background" onload="startTime()">
    ...
    <?php if (session()->get('ID') == $chatGroup['IDPengirim']) { ?>
                ...
                <center>
                    <div class="WadahEditComment">
                        ...
                        <div class="WadahEditKomenIsi">
                            <form action="/chatcontroller/updatechat/<?= $chatGroup['ID']; ?>" id="update" method="post" enctype="multipart/form-data">
                                <div>

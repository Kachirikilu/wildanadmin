            ...
            <center>
                <div class="WadahCreate">
                    <nav class="WadahCreateNav">
                        <a href="/article/<?= $createAdmin['Slug']; ?>" style="text-decoration: none;"><button id="buttonCreateBack">
                    ...
                    <div class="WadahCreateIsi">
                        <?= csrf_field(); ?>
                        <form action="/updatecontroller/updatedetail/<?= $createAdmin['ID']; ?>" id="update" method="post" enctype="multipart/form-data">
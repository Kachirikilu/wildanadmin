                    ...
                    <div class="WadahCreate">
                        ...
                        <div class="WadahCreateIsi">
                            <form action="/createcontroller/save" id="create" method="post" enctype="multipart/form-data">
                                <a style="color: red;"><?= $validation->getError('inputTittle') ?></a>
                                <div>
                                    <center><input class="inputCreateJ" type="text" id="inputTittle" name="inputTittle" placeholder="Title" required="" value="" autofocus></center>
                                </div>
                                ...
                                <div style="display: inline;" id="DivP1">
                                    ...
                                    <center><textarea class="inputTextContent" type="text" id="inputParagraf1" name="inputParagraf1" placeholder="Paragraph 1" required="" autofocus></textarea></center>

                                    <div class="wadahTextArea" id="inputCoding1X" style="display: none;">
                                        <div class="headerTextArea">
                                            <div>
                                                <button onclick="htmlButton1()" id="htmlButton1X" class="buttonRunCopy" form="">
                                                    html
                                                </button>
                                                <button onclick="cssButton1()" id="cssButton1X" class="buttonRunCopy" style="color: gray" form="">
                                                    css
                                                </button>
                                                <button onclick="jsButton1()" id="jsButton1X" class="buttonRunCopy" style="color: gray" form="">
                                                    javascript
                                                </button>
                                            </div>
                                            <div></div>
                                        </div>
                                        <!-- <textarea class="inputCoding" type="text" name="inputCoding1" placeholder="Coding 1" autofocus wrap="off"></textarea> -->
                                        <div class="wadahHTMLCSSJS">

                                            <div id="wadahHTML1">
                                                <textarea id="textArea1" class="textAreaDesain" name="inputCoding1" wrap="off"></textarea>
                                            </div>

                                            <div id="wadahCSS1" style="display: none;">
                                                <textarea id="cssCode1" class="textAreaDesain" wrap="off"></textarea>
                                            </div>

                                            <div id="wadahJS1" style="display: none;">
                                    ...
                                    <div class="wadahTextArea" id="inputCoding1" style="display: none;">
                                        ...
                                        <textarea id="textArea1" class="inputCoding" type="text" name="inputCoding1" wrap="off"></textarea>
                                    </div>
                                    ...
                                    <div style="display: none;" id="DivP2">
                                        ...
                                        <center><textarea class="inputTextContent" type="text" id="inputParagraf2" name="inputParagraf2" placeholder="Paragraph 2" autofocus></textarea></center>

                                        <div class="wadahTextArea" id="inputCoding2" style="display: none;">
                                            <div class="headerTextArea">
                                                <p id="infoCoding2"></p>
                                            </div>
                                            <textarea class="inputCoding" type="text" name="inputCoding2" placeholder="Coding 2" autofocus wrap="off"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div style="display: none;" id="DivP3">
                                        ...
                                        <center><textarea class="inputTextContent" type="text" id="inputParagraf3" name="inputParagraf3" placeholder="Paragraph 3" autofocus></textarea></center>

                                        <div class="wadahTextArea" id="inputCoding3" style="display: none;">
                                            <div class="headerTextArea">
                                                <p id="infoCoding3"></p>
                                            </div>
                                            <textarea class="inputCoding" type="text" name="inputCoding3" placeholder="Coding 3" autofocus wrap="off"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div style="display: none;" id="DivP4">
                                        ...
                                        <center><textarea class="inputTextContent" type="text" id="inputParagraf4" name="inputParagraf4" placeholder="Paragraph 4" autofocus></textarea></center>

                                        <div class="wadahTextArea" id="inputCoding4" style="display: none;">
                                            <div class="headerTextArea">
                                                <p id="infoCoding4"></p>
                                            </div>
                                            <textarea class="inputCoding" type="text" name="inputCoding4" placeholder="Coding 4" autofocus wrap="off"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div style="display: none;" id="DivP5">
                                        ...
                                        <center><textarea class="inputTextContent" type="text" id="inputParagraf5" name="inputParagraf5" placeholder="Paragraph 5" autofocus></textarea></center>

                                        <div class="wadahTextArea" id="inputCoding5" style="display: none;">
                                            <div class="headerTextArea">
                                                <p id="infoCoding5"></p>
                                            </div>
                                            <textarea class="inputCoding" type="text" name="inputCoding5" placeholder="Coding 5" autofocus wrap="off"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div style="display: none;" id="DivP6">
                                        ...
                                        <center><textarea class="inputTextContent" type="text" id="inputParagraf6" name="inputParagraf6" placeholder="Paragraph 6" autofocus></textarea></center>

                                        <div class="wadahTextArea" id="inputCoding6" style="display: none;">
                                            <div class="headerTextArea">
                                                <p id="infoCoding6"></p>
                                            </div>
                                            <textarea class="inputCoding" type="text" name="inputCoding6" placeholder="Coding 6" autofocus wrap="off"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div style="display: none;" id="DivP7">
                                        ...
                                        <center><textarea class="inputTextContent" type="text" id="inputParagraf7" name="inputParagraf7" placeholder="Paragraph 7" autofocus></textarea></center>

                                        <div class="wadahTextArea" id="inputCoding7" style="display: none;">
                                            <div class="headerTextArea">
                                                <p id="infoCoding7"></p>
                                            </div>
                                            <textarea class="inputCoding" type="text" name="inputCoding7" placeholder="Coding 7" autofocus wrap="off"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div style="display: none;" id="DivP8">
                                        ...
                                        <center><textarea class="inputTextContent" type="text" id="inputParagraf8" name="inputParagraf8" placeholder="Paragraph 8" autofocus></textarea></center>

                                        <div class="wadahTextArea" id="inputCoding8" style="display: none;">
                                            <div class="headerTextArea">
                                                <p id="infoCoding8"></p>
                                            </div>
                                            <textarea class="inputCoding" type="text" name="inputCoding8" placeholder="Coding 8" autofocus wrap="off"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div style="display: none;" id="DivP9">
                                        ...
                                        <center><textarea class="inputTextContent" type="text" id="inputParagraf9" name="inputParagraf9" placeholder="Paragraph 9" autofocus></textarea></center>

                                        <div class="wadahTextArea" id="inputCoding9" style="display: none;">
                                            <div class="headerTextArea">
                                                <p id="infoCoding9"></p>
                                            </div>
                                            <textarea class="inputCoding" type="text" name="inputCoding9" placeholder="Coding 9" autofocus wrap="off"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div style="display: none;" id="DivP10">
                                        ...
                                        <center><textarea class="inputTextContent" type="text" id="inputParagraf10" name="inputParagraf10" placeholder="Paragraph 10" autofocus></textarea></center>

                                        <div class="wadahTextArea" id="inputCoding10" style="display: none;">
                                            <div class="headerTextArea">
                                                <p id="infoCoding10"></p>
                                            </div>
                                            <textarea class="inputCoding" type="text" name="inputCoding10" placeholder="Coding 10" autofocus wrap="off"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div style="display: none;" id="DivP11">
                                        ...
                                        <center><textarea class="inputTextContent" type="text" id="inputParagraf11" name="inputParagraf11" placeholder="Paragraph 11" autofocus></textarea></center>

                                        <div class="wadahTextArea" id="inputCoding11" style="display: none;">
                                            <div class="headerTextArea">
                                                <p id="infoCoding11"></p>
                                            </div>
                                            <textarea class="inputCoding" type="text" name="inputCoding11" placeholder="Coding 11" autofocus wrap="off"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div style="display: none;" id="DivP12">
                                        ...
                                        <center><textarea class="inputTextContent" type="text" id="inputParagraf12" name="inputParagraf12" placeholder="Paragraph 12" autofocus></textarea></center>

                                        <div class="wadahTextArea" id="inputCoding12" style="display: none;">
                                            <div class="headerTextArea">
                                                <p id="infoCoding12"></p>
                                            </div>
                                            <textarea class="inputCoding" type="text" name="inputCoding12" placeholder="Coding 12" autofocus wrap="off"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <script>
  function sendData() {
    var code = editor.getValue(); // Ambil nilai textarea dari CodeMirror
    $.ajax({
      url: "<?= base_url('controller_name/method_name'); ?>",
      type: "POST", // Ganti dengan "GET" jika ingin menggunakan metode GET
      data: { code: code },
      success: function (response) {
        // Tanggapan dari server (controller) akan ditampilkan di sini
        alert("Data berhasil dikirim ke controller CI4!");
      },
      error: function () {
        ...
        <script src="/CSS & JS/codeMirror/codeMirror.js?v=<?php echo time(); ?>" defer></script>

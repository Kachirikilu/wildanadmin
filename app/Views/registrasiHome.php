    ...
    <div id="center">
        <div class="WadahRegistrasi">
            <nav class="WadahRegisterNavAwal">
                <a href="login" style="text-decoration: none;"><button id="buttonRegistrasiLogout">
                        <span id="textLogin">Login</span>
                        <span id="textRegistrasi">Registrasi Form</span>
                    </button></a>
            </nav>
            <form action="/registrasicontroller/save" id="registrasi" method="post" enctype="multipart/form-data">